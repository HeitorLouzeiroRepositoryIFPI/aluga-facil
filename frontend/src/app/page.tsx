        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filteredImoveis.map((imovel) => (
            <PropertyCard
              ...
              price={imovel.valorMensal}
              description={imovel.descricao}
              type={imovel.tipo}
              status={imovel.status}
              imageUrl={imovel.fotos?.[0]}
            />
          ))}
        </div>
      </main>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-xl font-bold text-gray-900 mb-4">AlugaFácil</h3>
              <p className="text-gray-600 mb-4 max-w-md">
                Encontre o imóvel perfeito para alugar. Conectamos proprietários e inquilinos
            ...
            <div>
              ...
              <ul className="space-y-4">
                ...
                <li>
                  <a href="/como-funciona" className="text-base text-gray-500 hover:text-gray-900">
                    Como Funciona
                  </a>
                </li>
                <li>
                  <a href="/contato" className="text-base text-gray-500 hover:text-gray-900">
                    Contato
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-4">
                <li>
                  <a href="/ajuda" className="text-base text-gray-500 hover:text-gray-900">
                    Central de Ajuda
                  </a>
                </li>
                <li>
                  <a href="/termos" className="text-base text-gray-500 hover:text-gray-900">
                    Termos de Uso
                  </a>
                </li>
                <li>
                  <a href="/privacidade" className="text-base text-gray-500 hover:text-gray-900">
          ...
          <div className="mt-8 border-t border-gray-200 pt-8 text-center text-sm text-gray-500">
            <p>© 2024 AlugaFácil. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
